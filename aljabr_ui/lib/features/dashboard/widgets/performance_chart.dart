...
class _PerformanceChartState extends State<PerformanceChart> {
  ...
  Widget _buildMetricStats() {
    ...
    return Row(
      ...
      children: [
        _buildStatChip(
            'Latest', latest.toStringAsFixed(1), AppTheme.primaryBlue, isDark),
        _buildStatChip(
            'Avg', avg.toStringAsFixed(1), AppTheme.secondaryPurple, isDark),
        _buildStatChip(
            'Max', max.toStringAsFixed(1), AppTheme.accentPink, isDark),
        _buildStatChip(
            'Min', min.toStringAsFixed(1), AppTheme.accentGreen, isDark),
      ],
    );
  }
