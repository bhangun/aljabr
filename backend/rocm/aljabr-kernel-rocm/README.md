...
```properties
# Enable ROCm runner
aljabr.runners.rocm.enabled=true
...
aljabr.runners.rocm.use-managed-memory=true
...
# Output
target/native/linux-x86_64/libaljabr_rocm_gfx942.hsaco
```
...
```java
import tech.kayys.aljabr.rocm.runner.RocmRunner;
import tech.kayys.aljabr.rocm.optimization.RocmOptimizationManager;
