package tech.kayys.aljabr.metal.detection;
...
import tech.kayys.aljabr.engine.routing.policy.SelectionPolicy;
import tech.kayys.aljabr.metal.config.MetalRunnerMode;
import tech.kayys.aljabr.spi.context.RequestContext;
import tech.kayys.aljabr.core.tensor.DeviceType;
import tech.kayys.aljabr.spi.model.ModelManifest;
import tech.kayys.aljabr.runner.RunnerCandidate;
import tech.kayys.aljabr.model.core.RunnerMetrics;
import tech.kayys.aljabr.model.core.HardwareDetector;
 ...
 * when the {@code aljabr-ext-metal} module is on the classpath.
 *
 * <p>
    ...
    public List<RunnerCandidate> rankRunners(
        ...
        if (mode == MetalRunnerMode.DISABLED) {
            ...
            if (ranked.size() < configuredRunners.size()) {
                LOG.info("[MetalPatch] Metal runners disabled via aljabr.runners.metal.mode=disabled");
            }
            return ranked;
        }
