...
public final class NativeMetal {
    ...
    static {
        // Load the native library (assuming aljabr-metal.dylib is in the library path)
        System.loadLibrary("aljabr-metal");
        LOOKUP = SymbolLookup.loaderLookup();

        INIT = link("aljabr_metal_init", FunctionDescriptor.of(ValueLayout.JAVA_INT));
        
        MATMUL = link("aljabr_metal_matmul", FunctionDescriptor.of(ValueLayout.JAVA_INT,
            ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
            ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.JAVA_INT,
            ValueLayout.JAVA_FLOAT, ValueLayout.JAVA_FLOAT));

        ATTENTION = link("aljabr_metal_attention", FunctionDescriptor.of(ValueLayout.JAVA_INT,
