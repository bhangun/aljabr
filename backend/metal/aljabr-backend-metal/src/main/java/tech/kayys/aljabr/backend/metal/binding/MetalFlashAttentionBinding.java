 ...
 *
 * <p>
 * Loads the FA4 symbols ({@code aljabr_metal_fa4_attention}, etc.) from
 * {@code libaljabr_metal.dylib} — the same dylib as {@link MetalBinding},
 * compiled from the modular Metal sources, including {@code aljabr_metal_fa4.m}.
 *
...
public class MetalFlashAttentionBinding {
    ...
    private static final String FN_FA4_ATTENTION = "aljabr_metal_fa4_attention";
    private static final String FN_SDPA_AVAILABLE = "aljabr_metal_fa4_sdpa_available";
    private static final String FN_BF16_AVAILABLE = "aljabr_metal_fa4_bf16_available";
    ...
    /**
     * Load FA4 symbols from {@code libaljabr_metal.dylib}.
     * The dylib must be compiled from the modular Metal sources, including
     * {@code aljabr_metal_fa4.m}.
     */
    /**
     ...
     * {@link tech.kayys.aljabr.kvcache.PagedKVCacheManager#getBlockPool()}
    ...
    private void bindAll() {
        // int aljabr_metal_fa4_attention(void*, void*, void*, void*,
        ...
        // int aljabr_metal_fa4_sdpa_available() -> int
        bind(FN_SDPA_AVAILABLE, FunctionDescriptor.of(ValueLayout.JAVA_INT));

        // int aljabr_metal_fa4_bf16_available() -> int
