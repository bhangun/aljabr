 ...
 * <li>Whether Metal is available by probing {@code libaljabr_metal.dylib}</li>
 * </ul>
 *
 * <h2>Integration with Aljabr's SelectionPolicy</h2>
 * <p>
 * The existing {@link tech.kayys.aljabr.engine.routing.policy.SelectionPolicy}
 ...
 * {@link tech.kayys.aljabr.spi.model.DeviceType#METAL} works correctly:
 *
 * <pre>{@code
