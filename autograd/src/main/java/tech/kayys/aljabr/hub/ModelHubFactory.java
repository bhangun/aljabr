package tech.kayys.aljabr.ml.hub;
...
import tech.kayys.aljabr.model.repo.local.LocalModelRepository;
    ...
    private static ModelRepository createStandaloneHF(HubConfig config) {
        ...
        HuggingFaceConfig hfConfig = new HuggingFaceConfig() {
            ...
            public String userAgent() {
                return "aljabr-sdk/" + config.revision();
            }
        ...
        return new HuggingFaceRepository(config.cacheDir(), client, hfConfig, new tech.kayys.aljabr.model.repo.local.ManifestStore());
    }
