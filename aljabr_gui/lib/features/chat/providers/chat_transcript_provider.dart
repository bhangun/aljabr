...
import '../../composer/services/markdown_stream_buffer.dart';
...
import '../../dashboard/models/metrics_entry.dart';
          ...
          if (channel == 'metrics') {
            try {
              ...
              try {
                ...
                final mEntry = MetricsEntry.fromInferenceMetrics(parsed,
                    sessionId: sessionId);
                ObjectBoxStore().metricsBox.put(mEntry);
              } catch (e) {
                logDebug('Failed to save metrics to ObjectBox: $e');
              }
            } catch (_) {}
