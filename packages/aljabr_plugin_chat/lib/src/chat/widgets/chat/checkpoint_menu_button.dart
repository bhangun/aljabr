...
import 'package:aljabr_plugin_chat/src/checkpoint/providers/checkpoint_providers.dart';
            ...
            child: Row(
              children: [
                const Icon(Icons.fiber_manual_record,
                    size: 8, color: AppTheme.accentBlue),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(_relativeTime(cp.createdAt),
                          style: const TextStyle(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            ...
            style:
                FilledButton.styleFrom(backgroundColor: AppTheme.accentAmber),
